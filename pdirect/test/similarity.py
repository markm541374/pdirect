...
xmin,ymin,state,batches=d.direct(f,lb,ub,maxf=200,vfrac=0.0000001)
...
sort0 = sorted(trace0[:cut],key=getk)
sort1 = sorted(trace1[:cut],key=getk)
dbyy=[]
for i in xrange(len(sort1)):
